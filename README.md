...
2. The most add-ons a single player bought is only 5. If the release date of these add-ons is fairly recent, then it can be a reflection of the recent release date (ie: customers have not had the time to buy the items). If the release date is not recent, either the game has enough perks that players do not feel the need to add on or players might not think the add-ons are worth the expense.
